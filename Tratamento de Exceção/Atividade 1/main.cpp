...
int main() {
    ...
    Curso c;
    char escolha;
    string nome, titulacao, endereco, curso, materia, CH;
    char cpf[11];
    int matricula, qtd_materias, i, cont, j, verificacao = 0;
    ...
    while (1)
    {
        ...
        case 'a':
            ...
            while (true) {
                try {
                    cout << "Informe os 11 dígitos do CPF do professor (somente números): ";
                    cin >> cpf;
                    cin.ignore();
                    c.TrataCPF(cpf);
                    break;
            ...
            while (true) {
                try {
                    cout << "Informe a carga horária da disciplina (somente em números): ";
                    getline(cin, CH);
                    c.TrataCH(CH);
                    break;
                }
                catch (ExcecaoCHInvalida &exch) {
                    cout << "ERRO: " << exch.what() << endl;
                }
            }
            d.setCH(CH);
            d.setProfessor(p);
        ...
        case 'c':
            ...
            while (true) {
                try {
                    cout << "Informe os 11 dígitos do CPF do aluno (somente números): ";
                    cin >> cpf;
                    cin.ignore();
                    c.TrataCPF(cpf);
                    break;
        ...
        case 'd':
            ...
            while (true) {
                try {
                    ...
                    cin >> matricula;
                    c.TrataMatricula(matricula);
                    break;
                }
                catch (ExcecaoAlunoInexistente& exaluno) {
                    cout << "ERRO: " << exaluno.what() << endl;
                }
            }
